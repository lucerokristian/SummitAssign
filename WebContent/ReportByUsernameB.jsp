			...
			<div class="page-container">
				<div class="pager-header">
					<div class="page-title">
						...
						<h1><small>Asset Assigned Report</small></h1>
					</div>
					<!-- END OF PAGE TITLE -->
						<!-- <form action="http://localhost:8080/AssetAssign/src/com/asset/controller/AssetController?action=reportbyusername" > -->
						<form method="POST" action='AssetController' name="frmAddUser">
					<div class="form-group">
						...
						<div class="col-md-3">
						<button type="submit" class="btn btn-primary" name="action" value="report">Search</button>
