		  ...
		  <%@include file="Header.jsp"%>
			<div class="page-container">
				<div class="pager-header">
					...
					<!-- END OF PAGE TITLE -->
					<form method="POST" action='AssetController' >
					<div class="form-group">
						<label class="col-md-3 control-label">Search Field</label>
						<div class="col-md-3">
						...
						<div class="col-md-3">
							<button type="submit" class="btn btn-primary" name="action" value="reportbystatus">Search</button>
						</div>
					</div>
					</form>
					<div></div>
